...
public class MFEA {
    ...
    public static ArrayList<Individual> SBX(Individual parentA, Individual parentB){
        ...
        Individual o1 = new Individual(maxTotalVertices, parentA.cost.length, parentA.NOVPCinCommonSpace.length, parentA.NOVPCinCommonSpace);
        Individual o2 = new Individual(maxTotalVertices, parentA.cost.length, parentA.NOVPCinCommonSpace.length, parentA.NOVPCinCommonSpace);
